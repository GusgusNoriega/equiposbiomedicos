...
@section('title', 'Editar producto biomedico')
@section('page-kicker', 'Catalogo biomedico')
@section('page-title', 'Editar producto biomedico')
@section('page-description', 'Actualiza la informacion descriptiva y tecnica del producto dentro del catalogo administrativo.')
